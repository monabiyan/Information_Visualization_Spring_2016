...
setwd("C:/Users/nabian.m/Dropbox/Spring 2106/Visualization/Proj3")
...
megacities<-c("Brockton,MA","Brookline,MA","Cambridge,MA","Chicopee,MA")
...
city_info<-data.frame(city_name,mean_price,median_pricemedian_reviews,mean_reviews,median_star,mean_star,mean_of_median_salary,population)
